...
SECRET_KEY = "django-insecure-opby-r=b)aa70^9p3t16lb9!r40w9n@vko&q+(l3$z9ovfynp!"
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': [
        ...
        'thoth.ordering.NullsLastOrderingFilter',
    ],
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173", 'http://localhost:3000', "https://thoth.ubyssey.ca", "https://api.thoth.ubyssey.ca", 
]
